...
//      }
		 ...
		 * 3.1) Create a TerrainQuad and name it "my terrain". 3.2) A good value for
		 * terrain tiles is 64x64 -- so we supply 64+1=65. 3.3) We prepared a heightmap
		 * of size 512x512 -- so we supply 512+1=513. 3.4) As LOD step scale we supply
