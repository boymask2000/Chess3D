...
import com.mygame.base.walkers.*;
 ...
 * @author giovanni
 */
public class ColtivatoreNew extends Walker0 {
    ...
    public ColtivatoreNew(EdificioColtivatore home, Vector3f centerArea, TipoProdotto tipoProdotto) {
        super(home);
    ...
    public void processStanding() {
        System.out.println( currentStato);
        switch (currentStato) {
            case ATTESA:
                counter = 0;
    ...
    public boolean processSeminando() {
       ...
       // Vector3f pos = getDestination();
        CommandMoveSemina c1 = new CommandMoveSemina(myHome, this, centerArea, tipoProdotto);
        c1.setDelayBefore(5);
        addCommand(c1);
    ...
    private Vector3f getDestination() {
        ...
        return myHome.getPositionCampo();
    }
